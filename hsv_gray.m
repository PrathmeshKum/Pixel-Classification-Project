 ...
 for iFile = 3:size(trainingImageFiles,1);  
        ...
        for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                gray=(floor(GRAY*0.1216*0.45))+1; % for converting to range: 1-32
                
                if bwMask(iRow,iCol)==1;
                    
                    Pr_x_given_w_equalsTo_1(h,s,v,gray) = Pr_x_given_w_equalsTo_1(h,s,v,gray) + 1;
                
                else
                    
                    Pr_x_given_w_equalsTo_0(h,s,v,gray) = Pr_x_given_w_equalsTo_0(h,s,v,gray) + 1;
    ...
    origIm4=rgb2gray(origIm); % converts rgb values into grayscale values in range: 0-255
     ...
     for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                if (Pr_x_given_w_equalsTo_1(h,s,v,gray)*Pr_w_equalsTo_1) > (Pr_x_given_w_equalsTo_0(h,s,v,gray)*Pr_w_equalsTo_0);
