 ...
 for iFile = 3:size(trainingImageFiles,1);  
        ...
        for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                h=(floor(hue*31.999*0.45))+1; % for converting to range: 1-8
                s=(floor(saturation*31.999*0.45))+1;
                v=(floor(value*31.999*0.45))+1;
                ...
                if bwMask(iRow,iCol)==1;
                    ...
                    Pr_x_given_w_equalsTo_1(r,g,b,h,s,v) = Pr_x_given_w_equalsTo_1(r,g,b,h,s,v) + 1;
                
                else
                    
                    Pr_x_given_w_equalsTo_0(r,g,b,h,s,v) = Pr_x_given_w_equalsTo_0(r,g,b,h,s,v) + 1;
    ...
    origIm2=rgb2hsv(origIm); % converts rgb values into hsv in range: 0-1    
     ...
     for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                h=(floor(hue*31.999*0.45))+1; % for converting to range: 1-32
                s=(floor(saturation*31.999*0.45))+1;
                v=(floor(value*31.999*0.45))+1;
                
                r=origIm(iRow,iCol,1);
                r=(floor(r*0.1216*0.45))+1; % 0.1216 factor for converting to 0-31 & +1 for range: 1-32
                g=origIm(iRow,iCol,2);
                g=(floor(g*0.1216*0.45))+1;
                b=origIm(iRow,iCol,3);
                b=(floor(b*0.1216*0.45))+1;
                
                if (Pr_x_given_w_equalsTo_1(r,g,b,h,s,v)*Pr_w_equalsTo_1) > (Pr_x_given_w_equalsTo_0(r,g,b,h,s,v)*Pr_w_equalsTo_0);
