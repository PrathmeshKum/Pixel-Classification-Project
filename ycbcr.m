 ...
 for iFile = 3:size(trainingImageFiles,1);  
        ...
        for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                y=(floor((Y-16)*0.1435))+1; % for converting into range: 1-32
                cb=(floor((CB-16)*0.1420))+1;
                cr=(floor((CR-16)*0.1420))+1; 
                
                
                if bwMask(iRow,iCol)==1;
                    
                    Pr_x_given_w_equalsTo_1(y,cb,cr) = Pr_x_given_w_equalsTo_1(y,cb,cr) + 1;
                
                else
                    
                    Pr_x_given_w_equalsTo_0(y,cb,cr) = Pr_x_given_w_equalsTo_0(y,cb,cr) + 1;
    ...
    origIm2=rgb2ycbcr(origIm); % converts rgb values into ycbcr in range (y: 16-235, cb & cr: 16-240)   
     ...
     for iRow = 1:nrows;
            ...
            for iCol = 1:ncols;
                ...
                if (Pr_x_given_w_equalsTo_1(y,cb,cr)*Pr_w_equalsTo_1) > (Pr_x_given_w_equalsTo_0(y,cb,cr)*Pr_w_equalsTo_0);
